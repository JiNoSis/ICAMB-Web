          ...
          <Switch>
            ...
            <MainLayout breakpoint={this.props.breakpoint}>
              <React.Suspense fallback={<PageSpinner />}>
                <Route exact path="/" component={AuthModalPage} />
                <Route exact path="/sample" component={Sample} />
                <Route exact path="/dash-board" component={SamplePage} />
                <Route exact path="/gyro-tables" component={GyroDataPage} />
                <Route exact path="/accel-tables" component={AccelDataPage} />
                <Route exact path="/load-tables" component={LoadDataPage} />
                <Route exact path="/humid-tables" component={HumidDataPage} />
                <Route exact path="/buttons" component={SamplePage} />
